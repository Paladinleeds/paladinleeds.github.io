# Plugins for use on computers

In here you will find the list of plugins made for use on computers. Primarily those running Windows and Mac, though Linux ports may exist for some of the plugins.
